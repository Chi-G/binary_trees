...
/**
 * height - func measures the height of a binary tree.
...
/**
 * balance - func measures the balance factor of a binary tree.
...
/**
 * avl_insert_recursive - func inserts a value into an AVL tree recursively.
