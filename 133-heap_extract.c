...
/**
 * tree_height - func measures the height of a binary tree
...
/**
 * tree_size_h - func measures the sum of heights of a binary tree
 * @tree: pointer to the root node of the tree to measure the height
 *
 * Return: Height or 0 if tree is NULL
 */
...
/**
 * _preorder - func goes through a binary tree using pre-order traversal
...
/**
 * heapify - func heapifies max binary heap
...
/**
 * heap_extract - func extracts the root node from a Max Binary Heap
