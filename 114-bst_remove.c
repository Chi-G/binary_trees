...
/**
 * inorder_successor - func returns the minimum value of a binary search tree.
...
/**
 * bst_delete - func deletes a node from a binary search tree.
...
/**
 * bst_remove_recursive - func removes a node from a binary search tree recursively.
