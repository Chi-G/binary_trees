...
/**
 * binary_tree_levelorder - func Goes through a binary tree
...
/**
 * levels_rec - func calls func on all nodes at each level.
...
/**
 * get_children - func appends children of parent to linked list.
...
/**
 * append - func adds a new node at the end of a linkedlist
...
/**
 * free_list - func frees all the nodes in a linked list
